...
#define STRING_CONFIG_H_AUTHOR "FURY" // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_RAMBO //FURY 
#endif
...
#define CUSTOM_MACHINE_NAME "TAZ 5" //FURY 

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "f1f49908-b0d9-4106-b3ed-ebbe01e45655" //FURY 
...
#define DEFAULT_NOMINAL_FILAMENT_DIA 2.85 //FURY 
...
#define HOTEND_OFFSET_X { 0.0, 0.00 } //FURY  (mm) relative X-offset for each nozzle
#define HOTEND_OFFSET_Y { 0.0, 0.00 }  //FURY  (mm) relative Y-offset for each nozzle
#define HOTEND_OFFSET_Z { 0.0, 0.00 }  //FURY  (mm) relative Z-offset for each nozzle
...
// Resistor values when using MAX31865 sensors (-5) on TEMP_SENSOR_0 / 1
  ...
  #define TEMP_RESIDENCY_TIME         3  //FURY  (seconds) Time to wait for hotend to "settle" in M109
  #define TEMP_WINDOW                  3  //FURY  (°C) Temperature proximity for the "temperature reached" timer
  #define TEMP_HYSTERESIS              3  //FURY  (°C) Temperature proximity considered "close enough" to the target
#endif

#if TEMP_SENSOR_BED
  #define TEMP_BED_RESIDENCY_TIME     3  //FURY  (seconds) Time to wait for bed to "settle" in M190
  #define TEMP_BED_WINDOW              3  //FURY  (°C) Temperature proximity for the "temperature reached" timer
  #define TEMP_BED_HYSTERESIS          3  //FURY  (°C) Temperature proximity considered "close enough" to the target
#endif
...
#define HEATER_0_MAXTEMP 305 //FURY 
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  28.79 //FURY 
    #define DEFAULT_Ki   1.91 //FURY 
    #define DEFAULT_Kd 108.51 //FURY 
  #endif
#else
 ...
 */
#define MAX_BED_POWER 206 //FURY  limits duty cycle to bed; 255=full current
...
#define PIDTEMPBED //FURY 
  ...
  #define DEFAULT_bedKp 162 //FURY 
  #define DEFAULT_bedKi 17 //FURY 
  #define DEFAULT_bedKd 378 //FURY 
...
// @section pid temp
  ...
  #define PID_AUTOTUNE_MENU     //FURY  Add PID auto-tuning to the "Advanced Settings" menu. (~250 bytes of flash)
#endif
...
#define EXTRUDE_MINTEMP 150 //FURY 
 ...
 */
#define X_MIN_ENDSTOP_HIT_STATE LOW //FURY 
#define X_MAX_ENDSTOP_HIT_STATE HIGH
#define Y_MIN_ENDSTOP_HIT_STATE LOW //FURY 
#define Y_MAX_ENDSTOP_HIT_STATE LOW //FURY 
#define Z_MIN_ENDSTOP_HIT_STATE HIGH
#define Z_MAX_ENDSTOP_HIT_STATE LOW //FURY 
 ...
 * :[2,3,4,5,6,7]
 */
#define ENDSTOP_NOISE_THRESHOLD 2 //FURY 
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 1600, 800 } //FURY 
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          {300, 300, 3, 25 } //FURY 
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      {9000, 9000, 100, 9000 } //FURY 
 ...
 */
#define DEFAULT_ACCELERATION          500    //FURY  X, Y, Z and E acceleration for printing moves
#define DEFAULT_RETRACT_ACCELERATION  3000    // E acceleration for retracts
#define DEFAULT_TRAVEL_ACCELERATION   500    //FURY  X, Y, Z acceleration for travel (non printing) moves
 ...
 */
#define CLASSIC_JERK //FURY 
#if ENABLED(CLASSIC_JERK)
  #define DEFAULT_XJERK 8 //FURY 
  #define DEFAULT_YJERK 8 //FURY 
  #define DEFAULT_ZJERK  0.4 //FURY 
  #define DEFAULT_EJERK  10 //FURY 
...
//#define Z_PROBE_SERVO_NR 0
  ...
  #define Z_SERVO_ANGLES {10, 90}      //FURY  Z Servo Deploy and Stow angles
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET {-51, 5, -1} //FURY  CHECK
...
#define PROBING_MARGIN 15 //FURY 

// X and Y axis travel speed (mm/min) between probes
#define XY_PROBE_FEEDRATE 18000 //FURY 
 ...
 */
#define MULTIPLE_PROBING 2 //FURY 
#define EXTRA_PROBING    1 //FURY 
 ...
 */
#define Z_CLEARANCE_DEPLOY_PROBE   15 //FURY  (mm) Z Clearance for Deploy/Stow
...
#define Z_MIN_PROBE_REPEATABILITY_TEST //FURY 
...
#endif
#define PROBING_FANS_OFF          //FURY  Turn fans off when probing
...
#define INVERT_E0_DIR true //FURY 
#define INVERT_E1_DIR true //FURY 
...
#define NO_MOTION_BEFORE_HOMING //FURY  Inhibit movement until all axes have been homed. Also enable HOME_AFTER_DEACTIVATE for extra safety.
#define HOME_AFTER_DEACTIVATE   //FURY  Require rehoming after steppers are deactivated. Also enable NO_MOTION_BEFORE_HOMING for extra safety.
...
#define Z_CLEARANCE_FOR_HOMING  10   //FURY  (mm) Minimal Z height before homing (G28) for Z clearance above the bed, clamps, ...
...
#define X_BED_SIZE 289.4 //FURY 
#define Y_BED_SIZE 276.4 //FURY 

// Travel limits (linear=mm, rotational=°) after homing, corresponding to endstop positions.
#define X_MIN_POS 0
#define Y_MIN_POS 0
#define Z_MIN_POS 0
#define X_MAX_POS 299.5 //FURY 
#define Y_MAX_POS 277.4 //FURY 
#define Z_MAX_POS 250 //FURY 
//#define I_MIN_POS 0
//#define I_MAX_POS 50
//#define J_MIN_POS 0
//#define J_MAX_POS 50
 ...
 */
#define FILAMENT_RUNOUT_SENSOR //FURY
#if ENABLED(FILAMENT_RUNOUT_SENSOR)
  #define FIL_RUNOUT_ENABLED_DEFAULT false //FURY Enable the sensor on startup. Override with M412 followed by M500.
...
#define AUTO_BED_LEVELING_UBL //FURY 
 ...
 */
#define RESTORE_LEVELING_AFTER_G28 //FURY 
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define GRID_MAX_POINTS_X 5 //FURY 
  ...
  #define MESH_INSET 15              //FURY  Set Mesh bounds as an inset region of the bed
  #define GRID_MAX_POINTS_X 5      //FURY  Don't use more than 15 points per axis, implementation limited.
  #define GRID_MAX_POINTS_Y GRID_MAX_POINTS_X

  #define UBL_HILBERT_CURVE       //FURY Use Hilbert distribution for less travel when probing multiple points
 ...
 */
#define EEPROM_SETTINGS     //FURY  Persistent storage with M500 and M501
//#define DISABLE_M503        // Saves ~2700 bytes of flash. Disable for release!
#define EEPROM_CHITCHAT       // Give feedback on EEPROM commands. Disable to save flash.
#define EEPROM_BOOT_SILENT    // Keep M503 quiet and only give errors during first load
#if ENABLED(EEPROM_SETTINGS)
  #define EEPROM_AUTO_INIT  //FURY  Init EEPROM automatically on any errors.
...
#define PREHEAT_1_TEMP_HOTEND 205 //FURY 
#define PREHEAT_1_TEMP_BED     60 //FURY 
 ...
 */
#define NOZZLE_PARK_FEATURE //FURY 

#if ENABLED(NOZZLE_PARK_FEATURE)
  // Specify a park position as { X, Y, Z_raise }
  #define NOZZLE_PARK_POINT {100, 267.4, 20} //FURY 
...
#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_START_POINT {{-17, 95, (Z_MIN_POS + 1)}} //FURY
  #define NOZZLE_CLEAN_END_POINT   {{-17, 25, (Z_MIN_POS + 1)}} //FURY
 ...
 */
//#define PRINTJOB_TIMER_AUTOSTART //FURY 
...
//
#define ENCODER_PULSES_PER_STEP 2 //FURY 

//
// Use this option to override the number of step signals required to
// move between next/prev menu items.
//
#define ENCODER_STEPS_PER_MENU_ITEM 1 //FURY 
...
//
#define INDIVIDUAL_AXIS_HOMING_MENU //FURY 
...
//
#define REPRAP_DISCOUNT_FULL_GRAPHIC_SMART_CONTROLLER //FURY 
 ...
 */
#define NUM_SERVOS 1 //FURY Note: Servo index starts with 0 for M280-M282 commands
